            ...
            <nav class="conteneurMenuGauche">
                <ul>
                    ...
                    <?php
                        ...
                        $vend="SELECT * FROM membre WHERE mail='$verMail'";
                        $sts2=$cnx->prepare($vend);
                        $sts2->execute();
                        $line2=$sts2->fetch(PDO::FETCH_ASSOC);
                        if($line1['id_type_membre']=2 || $line2['id_type_membre']=3)
                        {
                    ...
                    <form action="" method="post">
                        ...
                        <fieldset>
                            ...
                            <div class="champInfo">
                                ...
                                <input type="text" id="agentImmo" name="agentImmo" value="<?php echo $line['nom'];?>">
                            </div>
                        </fieldset>               
                    </form>
                </div>
                    ...
                    <form action="" method="post">
                        <fieldset>
                            ...
                            <div class="champInfo">
                                ...
                                <input type="text" id="nom" name="nom" value="<?php echo $line1['nom'];?>">
                            </div>
                            <div class="champInfo">
                                <label for="prenom">Prénom</label>
                                <input type="text" id="prenom" name="prenom" value="<?php echo $line1['prenom'];?>">
                            </div>
                            <div class="champInfo">
                                <label for="naissance">Date de naissance</label>
                                <input type="text" id="naissance" name="naissance" value="<?php echo $line1['date_naissance'];?>">
                            </div>
                            <div class="champInfo">
                                <label for="adresse">Adresse</label>
                                <input type="text" id="adresse" name="adresse" value="<?php echo $line1['adresse'];?>">
                            </div>
                            <div class="champInfo">
                            ...
                            <div class="champInfo">
                                ...
                                <input type="text" id="codePostal" name="codePostal" value="<?php echo $line1['code_postal'];?>">
                            </div>
                            <div class="champInfo">
                                <label for="adresse">Ville</label>
                                <input type="text" id="ville" name="ville" value="<?php echo $line1['ville'];?>">
                            </div>
                            <div class="champInfo">
                                <label for="telephone">Numéro de téléphone</label>
                                <input type="text" id="telephone" name="telephone" value="<?php echo $line1['numero_telephone'];?>">
                            </div>
                    ...
                    <form action="" method="post">
                        <fieldset>
                            ...
                            while($line=$stmt->fetch(PDO::FETCH_ASSOC))
                            {
                                ...
                                <div class="survolImage"><a class="consulter" href="bien.php?id='.$idBien.'"><i class="consulter fab fa-algolia"></i></a><a class="poubelle" href="supprimer-favoris.php?id='.$idBien.'"><i class="poubelle fas fa-trash-alt"></i></a></div>
                    ...
                    <form action="" method="post">
                        <fieldset>
                            ...
                            while($line=$stmt->fetch(PDO::FETCH_ASSOC))
                            {
                                ...
                                <div class="survolImage"><a class="consulter" href="bien.php?id='.$idBien.'"><i class="consulter fab fa-algolia"></i></a><a class="poubelle" href="supprimer-biens.php?id='.$idBien.'"><i class="poubelle fas fa-trash-alt"></i></a></div>
                                <div class="margeFav"></div>';
                            }
                            ?>
                        </fieldset>               
