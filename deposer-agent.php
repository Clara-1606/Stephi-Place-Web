...
?>
    ...
    <div class="conteneurDeposerTout">
        ...
        <div class="conteneurDeposer">
            <form action="depot-bien-agent.php" method="post" enctype="multipart/form-data">
                <fieldset>
                    <legend>Renseignement sur le vendeur</legend>
                    <div class="conteneurChampDepot">
                        <div>
                            <div class="champDepot champIdVendeur">
                                <label for="etageDepot">ID du vendeur</label>
                                <input type="number" id="idVendeur" name="idVendeur">
                            </div>     
                        </div>
                    </div>
                </fieldset>
